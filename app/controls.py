"""
Transport controls widget — play/pause, seek, volume, speed, fullscreen.

A bottom bar that provides all media transport controls with modern styling.
"""
...
class TransportBar(QWidget):
    ...
    def _setup_ui(self):
        ...
        self.time_current.setFixedWidth(55)
        ...
        self.time_total.setFixedWidth(55)
        ...
        # Left group: stop, rewind, play/pause, forward
